...
const SHELL_CACHE = 'av-shell-v42'; // v42: сброс аудио-кэша, чтобы телефоны перекачали faststart-версии дневных медитаций
...
const AUDIO_CACHE = 'av-audio-v3';  // кэш медитаций, переживает бампы оболочки (см. activate)
