...
function renderAccess() {
  ...
  return `
    ...
    ${installCard()}
    <hr class="divider" />
    <p class="dim small">Вопросы и возврат — <a href="../legal/kontakty.html" target="_blank" rel="noopener">напиши нам</a>, отвечает живой человек. Гарантия возврата 14 дней.</p>
    ...
    <p class="dim small" style="margin-top:14px">
      <a href="../legal/oferta.html" target="_blank" rel="noopener">Оферта</a> ·
      <a href="../legal/privacy.html" target="_blank" rel="noopener">Политика</a> ·
      <a href="../legal/soglasie.html" target="_blank" rel="noopener">Согласие</a> ·
      <a href="../legal/kontakty.html" target="_blank" rel="noopener">Контакты</a>
    </p>`;
}
